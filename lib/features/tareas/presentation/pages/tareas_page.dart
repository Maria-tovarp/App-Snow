  ...
  Future<void> load() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Error cargando tareas: $e')),
      );
    }
  }
...
class _CreateTareaModalState extends State<_CreateTareaModal> {
  ...
  void _fillDataIfEdit() {
    ...
    if (t.fechaVencimiento != null && t.fechaVencimiento!.isNotEmpty) {
      fechaEntrega = DateTime.tryParse(t.fechaVencimiento!);
    }
  }
  ...
  Future<void> _loadMaterias() async {
    try {
      ...
      setState(() {
        ...
        if (!existeMateria) materiaId = null;
      });
    } catch (_) {}
  }
  ...
  String _fechaLabel() {
    if (fechaEntrega == null) return 'dd/mm/aaaa';
    final d = fechaEntrega!;
